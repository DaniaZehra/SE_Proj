...
import { canActivateRepeatedly, createShadow, defaultSurveyAppearance, dismissedSurveyEvent, doesSurveyDeviceTypesMatch, doesSurveyMatchSelector, doesSurveyUrlMatch, getContrastingTextColor, getDisplayOrderQuestions, getInProgressSurveyState, getSurveyContainerClass, getSurveyResponseKey, getSurveySeen, hasWaitPeriodPassed, isSurveyInProgress, sendSurveyEvent, setInProgressSurveyState, style, SurveyContext, } from './surveys/surveys-extension-utils';
    ...
    function SurveyManager(posthog) {
        ...
        this._handlePopoverSurvey = function (survey) {
            ...
            if (!surveySeen) {
                ...
                if (delaySeconds <= 0) {
                    return Preact.render(<SurveyPopup key={'popover-survey'} posthog={_this._posthog} survey={survey} removeSurveyFromFocus={_this._removeSurveyFromFocus}/>, shadow_1);
                }
                var timeoutId = setTimeout(function () {
                    ...
                    Preact.render(<SurveyPopup key={'popover-survey'} posthog={_this._posthog} survey={__assign(__assign({}, survey), { appearance: __assign(__assign({}, survey.appearance), { surveyPopupDelaySeconds: 0 }) })} removeSurveyFromFocus={_this._removeSurveyFromFocus}/>, shadow_1);
                }, delaySeconds * 1000);
...
export var renderSurveysPreview = function (_a) {
    ...
    Preact.render(<SurveyPopup key="surveys-render-preview" survey={survey} forceDisableHtml={forceDisableHtml} style={{
            ...
            borderRadius: 10,
            color: textColor,
        }} onPreviewSubmit={onPreviewSubmit} previewPageIndex={previewPageIndex} removeSurveyFromFocus={function () { }}/>, parentElement);
};
...
export function SurveyPopup(_a) {
    var _b, _c, _d, _e;
    var survey = _a.survey, forceDisableHtml = _a.forceDisableHtml, posthog = _a.posthog, style = _a.style, previewPageIndex = _a.previewPageIndex, removeSurveyFromFocus = _a.removeSurveyFromFocus, _f = _a.isPopup, isPopup = _f === void 0 ? true : _f, _g = _a.onPreviewSubmit, onPreviewSubmit = _g === void 0 ? function () { } : _g, _h = _a.onPopupSurveyDismissed, onPopupSurveyDismissed = _h === void 0 ? function () { } : _h, _j = _a.onCloseConfirmationMessage, onCloseConfirmationMessage = _j === void 0 ? function () { } : _j;
    ...
    var surveyPopupDelayMilliseconds = ((_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.surveyPopupDelaySeconds)
        ...
        : 0;
    var _k = usePopupVisibility(survey, posthog, surveyPopupDelayMilliseconds, isPreviewMode, removeSurveyFromFocus), isPopupVisible = _k.isPopupVisible, isSurveySent = _k.isSurveySent, setIsPopupVisible = _k.setIsPopupVisible;
    ...
    return isPopupVisible ? (<SurveyContext.Provider value={surveyContextValue}>
...
export function Questions(_a) {
    ...
    }), 2), questionsResponses = _e[0], setQuestionsResponses = _e[1];
    var _f = useContext(SurveyContext), previewPageIndex = _f.previewPageIndex, onPopupSurveyDismissed = _f.onPopupSurveyDismissed, isPopup = _f.isPopup, onPreviewSubmit = _f.onPreviewSubmit, surveySubmissionId = _f.surveySubmissionId;
    ...
    return (<form className="survey-form" name="surveyForm" style={isPopup
            ...
            <div className="survey-box" style={isPopup
            ? {
                backgroundColor: ((_d = survey.appearance) === null || _d === void 0 ? void 0 : _d.backgroundColor) || defaultSurveyAppearance.backgroundColor,
            }
            : {}}>
...
export function FeedbackWidget(_a) {
    ...
    return (<Preact.Fragment>
            {((_e = survey.appearance) === null || _e === void 0 ? void 0 : _e.widgetType) === 'tab' && (<div className="ph-survey-widget-tab" onClick={function () { return !readOnly && setShowSurvey(!showSurvey); }}>
                    {((_f = survey.appearance) === null || _f === void 0 ? void 0 : _f.widgetLabel) || ''}
                </div>)}
            {showSurvey && (<SurveyPopup key={'feedback-widget-survey'} posthog={posthog} survey={survey} forceDisableHtml={forceDisableHtml} style={styleOverrides} removeSurveyFromFocus={removeSurveyFromFocus} onPopupSurveyDismissed={resetShowSurvey} onCloseConfirmationMessage={resetShowSurvey}/>)}
        </Preact.Fragment>);
}
