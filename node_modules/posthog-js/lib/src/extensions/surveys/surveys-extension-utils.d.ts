...
import { MultipleSurveyQuestion, Survey, SurveyAppearance, SurveyPosition, SurveyQuestion } from '../../posthog-surveys-types';
...
export declare const addSurveyCSSVariablesToElement: (element: HTMLDivElement, appearance?: SurveyAppearance | null) => void;
